...
public final class NavigationHeaderBinding implements ViewBinding {
  ...
  private NavigationHeaderBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageView) {
  ...
  public static NavigationHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NavigationHeaderBinding((LinearLayout) rootView, imageView);
    }
